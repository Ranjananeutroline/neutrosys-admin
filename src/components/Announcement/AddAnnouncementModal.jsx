...
import { createNewAnnouncement } from "../../redux/actions/announcementAction";
  ...
  const onSubmit = async (values, actions) => {
    ...
    try {
      const success = await dispatch(
        createNewAnnouncement({ title:title, message:message, description:description, validity:date })
      );
      if (success) {
        notify();
